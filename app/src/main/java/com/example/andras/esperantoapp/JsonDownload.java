...
public class JsonDownload {
    ...
    public ArrayList<PartData> downloadJson(final String url) {
        ...
        try {
            ...
            jsonArray = jsonObject.getJSONArray("Lesson 1");

            for (int i = 0; i < jsonArray.length(); i++) {
                jsonObject = jsonArray.getJSONObject(i);
                PartData partData = new PartData();
/*
            System.out.println("Type: " + jsonObject.optString("type"));
...
*/
            partData.setType(jsonObject.optString("type"));
            ...
            if(jsonObject.optString("picture") != "") {

                pictureSound.add(jsonObject.optString("picture"));

            }
            if(jsonObject.optString("sound") != "") {

                pictureSound.add(jsonObject.optString("sound"));
    ...
    public ArrayList<String> downloadPictureSound(){
